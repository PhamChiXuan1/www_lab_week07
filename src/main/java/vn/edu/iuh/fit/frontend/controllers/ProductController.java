...
public class ProductController {
    ...
    public String showProductListPaging(HttpSession session, Model model, @RequestParam("page")Optional<Integer> page, @RequestParam("size") Optional<Integer> size){
        ...
        Page<Product> candidatePage = productServices.findPagnated(currentPage-1, pageSize, "name", "asc");
    ...
    public String addCandidate(@ModelAttribute("product") Product product, BindingResult result, Model model){
